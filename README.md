...
・「Country.Of.Origin」（原産国）と「Region」（地域）ごとに「Acidity」（酸度）、「Aftertaste」（後味）、「Aroma」（香り）、「Balance」（バランス）、  
「Body」（ボディ）、「Flavor」（味）、の６項目について、値の平均をクロス集計で表示。  
・値の平均を５段階で色分け。  
